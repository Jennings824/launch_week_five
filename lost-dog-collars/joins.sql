...
--2)
SELECT lost_dog_collars.dog_name AS dog FROM lost_dog_collars
...
--4)
SELECT DISTINCT dog_owners.name AS owner, lost_dog_collars.dog_name AS dog FROM dog_owners
